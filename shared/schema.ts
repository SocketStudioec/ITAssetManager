...
export const insertAssetSchema = z.object({
  ...
  domainCost: z.preprocess((val) => (val === "" ? undefined : val), z.number().optional()),
  sslCost: z.preprocess((val) => (val === "" ? undefined : val), z.number().optional()),
  hostingCost: z.preprocess((val) => (val === "" ? undefined : val), z.number().optional()),
  serverCost: z.preprocess((val) => (val === "" ? undefined : val), z.number().optional()),
  domainExpiry: z.coerce.date().optional().nullable(),
