...
import { Laptop, DollarSign, CheckCircle, Wrench as WrenchIcon } from "lucide-react";
...
export default function PhysicalAssets() {
  ...
  // Cálculos de costos para activos físicos
  const monthlyRealPhysical = physicalAssets.reduce((sum: number, a: any) => sum + Number(a.monthly_cost || 0), 0);
  const annualRealPhysical = monthlyRealPhysical * 12;
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <main className="flex-1 overflow-y-auto bg-background">
          <div className="p-6">
            ...
            {/* ====== CARDS DE RESUMEN DE ACTIVOS FÍSICOS ====== */}
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">

              {/* Card 1: Total de Equipos */}
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-2xl font-bold text-foreground">
                        {isAssetsLoading ? "..." : physicalAssets.length}
                      </p>
                    </div>
                ...
                <CardContent className="p-6">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-2xl font-bold text-foreground">
                        {isAssetsLoading ? "..." : physicalAssets.filter((a: any) => a.status === "active").length}
                      </p>
                    </div>
                ...
                <CardContent className="p-6">
                  <div className="flex items-start justify-between">
                    <div>
                      ...
                      <p className="text-2xl font-bold text-foreground">
                        ${isAssetsLoading ? "..." : monthlyRealPhysical.toLocaleString()}
                      </p>
                    </div>
                ...
                <CardContent className="p-6">
                  <div className="flex items-start justify-between">
                    <div>
                      ...
                      <p className="text-2xl font-bold text-foreground">
                        ${isAssetsLoading ? "..." : annualRealPhysical.toLocaleString()}
                      </p>
                    </div>
                    ...
                    <CardContent className="p-6">
                      <div className="flex items-start justify-between mb-4">
                        <div className="flex-1">
                          ...
                          {/* Nuevo elelemnto para el codigo*/}
                          <p className="text-xs font-mono text-primary font-semibold">
                            {asset.asset_code || "Sin código"}
                          </p>
                      ...
                      <div className="space-y-2 text-sm">
                        ...
                        {asset.warrantyExpiry && (
                          <div className="flex justify-between">
                            ...
                            <span className={`font-medium ${new Date(asset.warrantyExpiry) < new Date()
                              ? 'text-destructive'
                        ...
                        <div className="flex justify-between">
                          <span className="text-muted-foreground">Costo Contable:</span>
                      ...
                      <div className="mt-4 pt-4 border-t border-border space-y-3">
                        ...
                        <div className="flex items-center justify-center space-x-1">
                          <Button variant="ghost" size="sm" onClick={() => setSelectedAssetForView(asset)} data-testid={`button-view-${asset.id}`}>
